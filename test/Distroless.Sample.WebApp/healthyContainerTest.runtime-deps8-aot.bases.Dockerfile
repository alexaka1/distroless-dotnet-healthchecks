...
FROM mcr.microsoft.com/dotnet/nightly/runtime-deps:8.0
FROM mcr.microsoft.com/dotnet/nightly/runtime-deps:8.0-noble
FROM mcr.microsoft.com/dotnet/nightly/runtime-deps:8.0-jammy
